...
<html>
	...
	<body>
		<form id="login_form" method="POST" action="/index.php/regest">
			<p>login</p>
			<input type="text", name="name" class="login_input" id="name" <?php if(isset($data['back'])) {echo "value=\"{$data['back']['name']}\"";}?> placeholder="name" />
			...
			<input type="text", name="age" class="login_input" id="age" <?php if(isset($data['back'])) {echo "value=\"{$data['back']['age']}\"";}?> placeholder="age" />
